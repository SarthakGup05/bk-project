      ...
      <div className=" container bg-white mx-auto">
        <div className=" bg-white shadow-none  h-max max-w-full rounded-none px-4 ">
          <div className="flex lg:hidden  items-center justify-center  h-full gap-9">
            <h2 className="px-3 py-2 rounded text-[14px] text-white bg-[url('/images/gBg.avif')] bg-center bg-cover">
              <span className="font-semibold text-gray-600">Online Exams </span>
            </h2>
          </div>
